  ...
  useEffect(() => {
    ...
    const renderFrame = () => {
      ...
      if (container.scrollLeft >= maxScroll * 0.8)
        container.scrollLeft = maxScroll * 0.2;
      else if (container.scrollLeft <= maxScroll * 0.1)
        container.scrollLeft = maxScroll * 0.7;
      ...
      <div className="container mx-auto px-16 md:px-8 relative z-10">
        ...
        <div className="flex flex-col items-center text-center w-full max-w-4xl mx-auto mb-12 md:mb-20">
          ...
          <div className="flex justify-center gap-4 w-full">
            <Button className="px-3! py-2! text-sm! md:px-6 md:py-3 md:text-base rounded-lg shadow-lg shadow-pacil-blue-200">
              Explore More
            </Button>
            <Button
              variant="outline"
              className="!px-3 !py-2 !text-sm md:px-6 md:py-3 md:text-base border-gray-300 text-gray-700 hover:bg-gray-50"
            >
              Grand Design
            </Button>
          </div>
        ...
        <div className="flex flex-col gap-10 md:gap-16 w-full">
          ...
          <div className="flex flex-row justify-center gap-8 md:gap-12 px-4 md:px-0 w-full -mt-32">
            {statistics.map((stat, idx) => (
              ...
              >
                <h3 className="text-2xl md:text-4xl md:font-extrabold font-bold text-black">
                  {stat.number}
                </h3>
