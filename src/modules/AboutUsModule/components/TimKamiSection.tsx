          ...
          <div className="w-1/2 md:w-1/6 bg-pacil-blue-800 md:bg-white rounded-lg md:rounded-2xl min-w-0">
            ...
            <div className="px-4 py-2 md:hidden w-full flex justify-start relative">
              <button
                ...
                className="w-full flex justify-between text-left text-white font-bold"
              >
                <svg
            ...
            <div className="min-h-[350px]">
              {activeTab === "tentang" ? (
                <div className="">
                  ...
                  {/* LIST PENGURUS */}
                  <h4 className="text-2xl font-semibold text-black mb-6 w-full p-4">
                    Pengurus
                  </h4>
                    ...
                    <div className="bg-white rounded-2xl border-4 border-white shadow-sm w-full px-4">
                      <div className="flex flex-row overflow-x-auto w-full scrollbar-hide gap-4 py-4 px-2">
                        {activeBiro.members.map((member, idx) => (
                          <div
                            key={idx}
                            className="flex-shrink-0 w-[200px] group cursor-pointer shadow-lg rounded-2xl bg-white border border-gray-100"
                          >
                            {/* FOTO */}
                            ...
                            <div className="px-4 py-4 gap-1">
                              <h5 className="font-bold text-gray-900 leading-tight mb-1">
                                {member.name}
                              </h5>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {activeBiro.programs.length > 0 ? (
                      activeBiro.programs.map((proker, idx) => (
                        <div
                          key={idx}
                          className="bg-white border border-gray-100 rounded-2xl p-4 shadow-sm hover:shadow-md transition-all hover:-translate-y-1 group"
                        >
