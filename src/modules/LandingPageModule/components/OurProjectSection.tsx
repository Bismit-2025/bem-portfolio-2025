...
export default function ProjectSection() {
  ...
  const radius = useScrollRadius(ref, {
    maxRadius: isMobile ? 100 : 226, // Matching the max radius from the original static design
  });
  ...
  return (
    <section className="w-full">
      <motion.div
        ...
        className="w-full py-16 md:py-20 overflow-hidden bg-linear-to-b from-pacil-red-200 via-[#F8F8F8] to-gray-100"
      >
        <div className="container px-8 lg:mx-auto z-1 flex flex-col justify-center items-center">
          ...
          <div className="text-center mb-8 md:mt-16">
            <h2 className="text-2xl md:text-5xl font-black bg-linear-to-r from-pacil-blue-700 to-pacil-red-700 bg-clip-text text-transparent inline-block pb-2">
              Our Projects
            </h2>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-x-6 gap-y-4 auto-rows-[100px] lg:auto-rows-[220px]">
            {/* CARD 1: TEXT INFO  */}
            <div className="row-span-1 lg:rounded-3xl rounded-lg p-[2px] bg-linear-to-br from-pacil-blue-800 to-pacil-red-800 drop-shadow-xl relative">
              <div className="w-full h-full bg-white rounded-[6px] lg:rounded-[21px] p-8 flex flex-col justify-start items-center text-center relative overflow-hidden">
                <h3 className="text-lg lg:text-3xl font-bold text-black mb-3 mt-2 relative z-10">
                  Project
                </h3>
